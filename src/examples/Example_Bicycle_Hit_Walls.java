...
public class Example_Bicycle_Hit_Walls implements IExample
{
    private static GridWorld learningWorld;
    private static GridWorld testingWorld;

    public Example_Bicycle_Hit_Walls()
    {
    ...
    {
        // Row 0
        learningWorld.setFeature(0,0,  new double[] {-5});
        learningWorld.setFeature(0,1,  new double[] {-5});
        learningWorld.setFeature(0,2,  new double[] {-5});
        learningWorld.setFeature(0,3,  new double[] {-5});
        learningWorld.setFeature(0,4,  new double[] {-5});
        learningWorld.setFeature(0,5,  new double[] {-5});
        learningWorld.setFeature(0,6,  new double[] {-5});
        learningWorld.setFeature(0,7,  new double[] {-5});
        learningWorld.setFeature(0,8,  new double[] {-5});
        learningWorld.setFeature(0,9,  new double[] {-5});
        learningWorld.setFeature(0,10,  new double[] {-5});
        learningWorld.setFeature(0,11,  new double[] {-5});
        learningWorld.setFeature(0,12,  new double[] {-5});
        learningWorld.setFeature(0,13,  new double[] {-5});
        learningWorld.setFeature(0,14,  new double[] {-5});
        learningWorld.setFeature(0,15,  new double[] {-5});
        ...
        learningWorld.setFeature(1,9,  new double[] {1});
        learningWorld.setFeature(1,10,  new double[] {1});
    ...
    public Policy getExpertPolicy()
    {
        ...
        expertPolicy.setCell(0,5, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,6, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,7, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,8, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,9, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,10, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,11, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,12, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,13, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,14, new Vector(new double[] {0, 1, 0, 0}));
        expertPolicy.setCell(0,15, new Vector(new double[] {0, 1, 0, 0}));
        ...
        expertPolicy.setCell(1,6, new Vector(new double[] {1, 0, 0, 0}));
        expertPolicy.setCell(1,7, new Vector(new double[] {1, 0, 0, 0}));
        expertPolicy.setCell(1,8, new Vector(new double[] {1, 0, 0, 0}));
        expertPolicy.setCell(1,9, new Vector(new double[] {1, 0, 0, 0}));
        expertPolicy.setCell(1,10, new Vector(new double[] {1, 0, 0, 0}));
        expertPolicy.setCell(1,11, new Vector(new double[] {1, 0, 0, 0}));
        expertPolicy.setCell(1,12, new Vector(new double[] {1, 0, 0, 0}));
        expertPolicy.setCell(1,13, new Vector(new double[] {1, 0, 0, 0}));
        expertPolicy.setCell(1,14, new Vector(new double[] {1, 0, 0, 0}));
        expertPolicy.setCell(1,15, new Vector(new double[] {1, 0, 0, 0}));
    ...
    public GridWorld getTestingWorld()
    {
        ...
        testingWorld.setFeature(3,4, new double[] {0.6});
        testingWorld.setFeature(3,5, new double[] {0.6});
        testingWorld.setFeature(3,6, new double[] {0.6});
        testingWorld.setFeature(3,7, new double[] {1});
        testingWorld.setFeature(3,8, new double[] {1});
        testingWorld.setFeature(3,9, new double[] {1});
        testingWorld.setFeature(3,10, new double[] {0.2});
        testingWorld.setFeature(3,11, new double[] {0.2});
        ...
        testingWorld.setFeature(4,10, new double[] {0.2});
        testingWorld.setFeature(4,11, new double[] {0.2});
        ...
        testingWorld.setFeature(5,1, new double[] {1});
        ...
        testingWorld.setFeature(5,8, new double[] {0.4});
        testingWorld.setFeature(5,9, new double[] {0.4});
        testingWorld.setFeature(5,10, new double[] {0.4});
        ...
        testingWorld.setFeature(6,8, new double[] {0.2});
        testingWorld.setFeature(6,9, new double[] {0.2});
        testingWorld.setFeature(6,10, new double[] {0.2});
