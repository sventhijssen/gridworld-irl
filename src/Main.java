public class Main
{
    public static void main(String [ ] args)
    {
        ...
        // Row 0
        gridWorld.setFeature(0,0, new double[] {0, Math.exp(-1/4)});
        gridWorld.setFeature(0,1, new double[] {0, Math.exp(-1/5)});
        gridWorld.setFeature(0,2, new double[] {0, Math.exp(-1/6)});
        gridWorld.setFeature(0,3, new double[] {0, Math.exp(-1/6)});
        gridWorld.setFeature(0,4, new double[] {0, Math.exp(-1/8)});
        gridWorld.setFeature(0,5, new double[] {1, Math.exp(-1/9)});


        // Row 1
        gridWorld.setFeature(1,0, new double[] {0, Math.exp(-1/3)});
        gridWorld.setFeature(1,1, new double[] {0, Math.exp(-1/4)});
        gridWorld.setFeature(1,2, new double[] {0, Math.exp(-1/5)});
        gridWorld.setFeature(1,3, new double[] {0, Math.exp(-1/6)});
        gridWorld.setFeature(1,4, new double[] {0, Math.exp(-1/7)});
        gridWorld.setFeature(1,5, new double[] {0, Math.exp(-1/8)});

        // Row 2
        gridWorld.setFeature(2,0, new double[] {0, Math.exp(-1/2)});
        gridWorld.setFeature(2,1, new double[] {0, Math.exp(-1/3)});
        gridWorld.setFeature(2,2, new double[] {1, Math.exp(-1/4)});
        gridWorld.setFeature(2,3, new double[] {1, Math.exp(-1/5)});
        gridWorld.setFeature(2,4, new double[] {0, Math.exp(-1/6)});
        gridWorld.setFeature(2,5, new double[] {0, Math.exp(-1/7)});

        // Row 3
        gridWorld.setFeature(3,0, new double[] {0, Math.exp(-1)});
        gridWorld.setFeature(3,1, new double[] {0, Math.exp(-1/2)});
        gridWorld.setFeature(3,2, new double[] {0, Math.exp(-1/3)});
        gridWorld.setFeature(3,3, new double[] {0, Math.exp(-1/4)});
        gridWorld.setFeature(3,4, new double[] {0, Math.exp(-1/5)});
        gridWorld.setFeature(3,5, new double[] {0, Math.exp(-1/6)});
        ...
        // Row 0
        testingWorld.setFeature(0,0, new double[] {0, Math.exp(-1)});
        testingWorld.setFeature(0,1, new double[] {0, Math.exp(-1/2)});
        testingWorld.setFeature(0,2, new double[] {0, Math.exp(-1/3)});
        testingWorld.setFeature(0,3, new double[] {0, Math.exp(-1/4)});
        testingWorld.setFeature(0,4, new double[] {0, Math.exp(-1/5)});
        testingWorld.setFeature(0,5, new double[] {0, Math.exp(-1/6)});


        // Row 1
        testingWorld.setFeature(1,0, new double[] {0, Math.exp(-1/2)});
        testingWorld.setFeature(1,1, new double[] {0, Math.exp(-1/3)});
        testingWorld.setFeature(1,2, new double[] {0, Math.exp(-1/4)});
        testingWorld.setFeature(1,3, new double[] {0, Math.exp(-1/5)});
        testingWorld.setFeature(1,4, new double[] {0, Math.exp(-1/6)});
        testingWorld.setFeature(1,5, new double[] {0, Math.exp(-1/7)});

        // Row 2
        testingWorld.setFeature(2,0, new double[] {0, Math.exp(-1/3)});
        testingWorld.setFeature(2,1, new double[] {0, Math.exp(-1/4)});
        testingWorld.setFeature(2,2, new double[] {0, Math.exp(-1/5)});
        testingWorld.setFeature(2,3, new double[] {0, Math.exp(-1/6)});
        testingWorld.setFeature(2,4, new double[] {0, Math.exp(-1/7)});
        testingWorld.setFeature(2,5, new double[] {0, Math.exp(-1/8)});

        // Row 3
        testingWorld.setFeature(3,0, new double[] {1, Math.exp(-1/4)});
        testingWorld.setFeature(3,1, new double[] {0, Math.exp(-1/5)});
        testingWorld.setFeature(3,2, new double[] {0, Math.exp(-1/6)});
        testingWorld.setFeature(3,3, new double[] {0, Math.exp(-1/7)});
        testingWorld.setFeature(3,4, new double[] {0, Math.exp(-1/8)});
        testingWorld.setFeature(3,5, new double[] {1, Math.exp(-1/9)});
